...
class FinalprojectFinished extends StatefulWidget {
  ...
  @override
  State<FinalprojectFinished> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<FinalprojectFinished> {
  final CollectionReference _booksCollection =
      FirebaseFirestore.instance.collection('finished');
                ...
                builder: (context, snapshot) {
                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return buildFinishedGridItem(
                        title: item['finished_bookTitle'] ?? 'No Title',
                        details: item['finished_bookAuthor'] ?? 'No Details',
                        desciption: item['finished_bookDescription'] ??
                            'No Description',
                        imageUrl: item['finished_imageUrl'] ?? 'No image',
                        docId: docId,
                      );
                    },
                  );
